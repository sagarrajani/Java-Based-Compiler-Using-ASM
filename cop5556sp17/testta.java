...
public class CodeGenVisitorTesting {
	...
	public void testIfByIdentLit() throws Exception {
		...
		String input = progname
				+ " {boolean a boolean b b<-true; if(b) {a<-true;}}";
	...
	public void testIfBinaryLE() throws Exception {
		...
		String input = progname
				+ " {boolean a boolean b b<-true; if(3<=3) {a<-true;}}";
	...
	public void testIfBinaryLT() throws Exception {
		...
		String input = progname
				+ " {boolean a boolean b b<-true; if(3<10) {a<-true;}}";
	...
	public void testIfBinaryGE() throws Exception {
		...
		String input = progname
				+ " {boolean a boolean b b<-true; if(10>=10) {a<-true;}}";
	...
	public void testIfBinaryGT() throws Exception {
		...
		String input = progname
				+ " {boolean a boolean b b<-true; if(10>9) {a<-true;}}";
	...
	public void testWhileTrue() throws Exception {
		...
		String input = progname
				+ " {boolean a boolean b b<-true; while(b) {a<-true; b<-false;}}";
	...
	public void testWhileWithBinaryGT() throws Exception {
		...
		String input = progname
				+ " {integer a boolean b a<-5; while(a>3) { a<- a-1;}}";
	...
	public void testWhileWithBinaryLE() throws Exception {
		...
		String input = progname
				+ " {integer a integer b a<-5; b<-1; while(a<=8) { a<- a+b;}}";
	...
	public void testIfBinaryLEIntLitCondition() throws Exception {
		...
		String input = progname
				+ " {boolean a integer b integer c c<-6; b<-6; if(c<=b) {a<-true;}}";
	...
	public void testIfBinaryLTIntLitCondition() throws Exception {
		...
		String input = progname
				+ " {boolean a integer b integer c c<-6; b<-4; if(b<c) {a<-true;}}";
	...
	public void testIfBinaryGEIntLitCondition() throws Exception {
		...
		String input = progname
				+ " {boolean a integer b integer c c<-6; b<-4; if(c>=b) {a<-true;}}";
	...
	public void testWhileFalse() throws Exception {
		...
		String input = progname
				+ " {boolean a boolean b b<-false; while(b) {a<-true; b<-false;}}";
	...
	public void testWhileFailWithBinaryGT() throws Exception {
		...
		String input = progname
				+ " {integer a boolean b a<-5; while(a>6) { a<- a-1;}}";
	...
	public void testWhileFailWithBinaryLE() throws Exception {
		...
		String input = progname
				+ " {integer a integer b a<-5; b<-1; while(a<=4) { a<- a+b;}}";
	...
	public void testWhileFailWithBinaryLT() throws Exception {
		...
		String input = progname
				+ " {integer a integer b a<-5; b<-1; while(a<5) { a<- a+b;}}";
	...
	public void testIfParamDec2Int() throws Exception {
		...
		String input = progname
				+ " integer abc {integer a a<-abc; if(a>10) {a<-5;}}";
	...
	public void testIfParamDec3Int() throws Exception {
		...
		String input = progname
				+ " integer abc, integer def {integer a a<-abc; if(a+def>52) {a<-5;}}";
	...
	public void testIfParamDec6BoolInt() throws Exception {
		...
		String input = progname
				+ " boolean boolLit, integer intLit {integer a if(boolLit) {a<-intLit;}}";
	...
	public void testANDBoolean1() throws Exception {
		...
		String input = progname
				+ " {boolean a boolean b integer c a<-true; b<-true; if(a&b){ c<-10;}}";
	...
	public void testANDBoolean2() throws Exception {
		...
		String input = progname
				+ " {boolean a boolean b integer c a<-false; b<-true; if(a&b){ c<-10;}}";
	...
	public void testANDBoolean3() throws Exception {
		...
		String input = progname
				+ " {boolean a boolean b integer c a<-true; b<-false; if(a&b){ c<-10;}}";
	...
	public void testANDBoolean4() throws Exception {
		...
		String input = progname
				+ " {boolean a boolean b integer c a<-false; b<-false; if(a&b){ c<-10;}}";
	...
	public void testORParamDecBoolean1() throws Exception {
		...
		String input = progname
				+ " boolean a {boolean b integer c b<-false; integer ghi if(a|b){ c<-10;}}";
	...
	public void testANDParamDecBoolean1() throws Exception {
		...
		String input = progname
				+ " boolean a {boolean b integer c b<-true; if(a&b){ c<-10;}}";
	...
	public void testANDParamDecBoolean2() throws Exception {
		...
		String input = progname
				+ " integer a {boolean b integer c b<-true; c<-6; if(a+c<=5){ c<-10; b<-false;}}";
	...
	public void testANDParamDecBoolean3() throws Exception {
		...
		String input = progname
				+ " integer a, integer deb, boolean xyz { if(a+deb<=5){ xyz<-true;}}";
	...
	public void paramInitialization1() throws Exception {
		...
		String input = name
				+ " integer i1, integer i2 {integer i3 i3 <- i1 + i2;}";
	...
	public void booleanLitExp0() throws Exception {
		...
		String input = name
				+ " boolean b1, boolean b2 {boolean b3 b3 <- b1 < b2;}";
	...
	public void ifStatement1() throws Exception {
		...
		String input = _input
				+ " if ((i1+i2) >= i2*2) {i3 <- i1+i2; i2 <- (i2*10 + i1/5) - i2*2;}}";
	...
	public void ifStatement2() throws Exception {
		...
		String _input = name
				+ " integer i1, integer i2, integer i4 {\n integer i3";
	...
	public void whileStatement2() throws Exception {
		...
		String input = _input
				+ " while (i1 > i2) {i3 <- (i3+10)*i2; i1 <- i1-1;}}";
	...
	public void sleepStatement0() throws Exception {
		...
		String[] args = new String[] {
				...
				"/home/gyan/Desktop/plp-assignment/project-1/plp-assignment1/images/imgout-8.jpg" }; // create
																										// String[]
																										// array
																										// to
																										// initialize
	...
	public void assng6Test0() throws Exception {
		...
		args[0] = new String("images/imgin-1.jpg");
		args[1] = new String("images/imgout-8.jpg");
		Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
		// instance.run();
	}
 ...
 * move it by adding 500 to its original xloc and yloc and show
	...
	public void assng6Test10() throws Exception {
		...
		input += " in->i;}";
		// input +=
		// " in->i->fm->move(1,2)->show; sleep(1000);\n fm->xloc->x; fm->yloc->y;";
		...
		args[0] = new String("images/imgin-4.jpg");
		args[1] = new String("images/imgin-5.jpg");
		Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
		// instance.run();
	}
}
...
public class testta {
	...
	String progname = "Prog";
	String input = progname
		+ " boolean b1, integer int1 { integer int1 integer int2}";
	Scanner scanner = new Scanner(input);
	scanner.scan();
	Parser parser = new Parser(scanner);
	ASTNode program = parser.parse();
	...
	String progname = "Prog";
	String input = progname
		+ " boolean b1, integer int1 { integer int1 integer int2 image img1 frame frame1}";
	Scanner scanner = new Scanner(input);
	scanner.scan();
	Parser parser = new Parser(scanner);
	ASTNode program = parser.parse();
	...
	String progname = "Prog";
	String input = progname
		+ " boolean b1, integer int1, file f, url url1{ integer int1 integer int2 boolean b3"
		+ "\nint1 <- 5; " + "\nint2 <- 500; " + "\nb3 <- true;"
	...
	// directly execute bytecode
	String[] args = { "true", "345", "abcd.png", "http://google.com/" }; // create
	// command
	// line
	// argument
	// array
	...
	String progname = "Prog";
	String input = progname
		+ " boolean b1, integer int6, integer int5, file f, url url1, file file1{ \n"
		+ "integer int1 integer int2 boolean b3 image img1 image img2 frame frame1"
		+ "\nint1 <- 5; " + "\nint2 <- 500; " + "\nb3 <- true;"
		+ "\nb1 <- false;" + "\nb3 <- b1;" + "\nb1 <- b3;"
		+ "\nf -> img1;" + "\nurl1 -> img1;" + "img1 ->file1;"
		+ "\nimg1->img2;" + "\nint1->int2;" + "\nint6->int1;"
		+ "\nint2->int1; \nint2->int6;" + "\nint6->int5;"
		+ "\nimg1->frame1;}";
	...
	String input = progname
		...
		// + "frame1->hide->show;"
		+ "img1->convolve->frame1->show;" + "img1->gray->frame1->show;"
		+ "img1|->gray->frame1->show;" + "frame1->hide->show;}";
	/*
	 * + "img1->width;" + "img1->width->int1;" + "img1->height;" +
	 * "img1->height->int6;" + "img1->scale(15)->frame1->show;" +
	 * "img1->scale(5);" + "frame1->show;}";
	 */
	// "file1 <- f;}"; this is illegal
	...
	String input = progname
		...
		+ "\nimg1->frame1->xloc->int1;" + "frame1->yloc;"
		+ "frame1->yloc;" + "frame1->yloc->int2;}";
	// "file1 <- f;}"; this is illegal
	...
	String input = progname
		...
		+ "\nf -> img1;" + "\nurl1 -> img2;" + "targetImg<-img1+img2;"
		+ "targetImg<-img1-img2;" + "targetImg<-img1*12;"
		+ "targetImg->scale(10)->frame1->show;" + "targetImg<-12*img2;"
		+ "targetImg->scale(10)->frame1->show;" + "targetImg<-img2/2;"
		+ "targetImg->scale(2)->frame1->show;" + "targetImg<-img2%2;"
	...
	String[] args = {
		...
		"345",
		"89",
		"/Users/sagarrajani/Documents/workspaceneon/PLP_HOMEWORK_5/src/smallsize.jpg",
		"https://www.craigjoneswildlifephotography.co.uk/blog/wp-content/uploads/2010/07/CMJ4893Jpeg-FB.jpg",
		"don't testit" }; // create command line argument array
	try {
	    Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
	...
	String input = "subImage url u {image i image j "
		+ "image k frame f \nu -> i; "
		+ "\nu -> j; \n k <- i-j; k -> f -> show;\n}";
	...
	// directly execute bytecode
	String[] args = { "http://icons.iconarchive.com/icons/yellowicon/game-stars/256/Mario-icon.png" }; // create
													   // command
													   // line
													   // argument
													   // array
	...
	String[] args = {
		...
		"download" }; // create command line argument array
	try {
	    Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
	    instance.run();
	} catch (InvocationTargetException e) {
	...
	// directly execute bytecode
	String[] args = { "abcd.png" }; // create command line argument array
	try {
	    Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
	    instance.run();
	} catch (InvocationTargetException e) {
	...
	// directly execute bytecode
	String[] args = { "http://icons.iconarchive.com/icons/yellowicon/game-stars/256/Mario-icon.png","hello" }; // create
													   // command
													   // line
													   // argument
													   // array
    ...
    public void testexprComp() throws Exception {
	String progname = "Prog";
	...
	// directly execute bytecode
	String[] args = {}; // create command line argument
						// array to initialize
						// params, none in this case
	try {
		Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
...
public void testModImage() throws Exception {
	...
	// directly execute bytecode
	String[] args = {"http://icons.iconarchive.com/icons/yellowicon/game-stars/256/Mario-icon.png"}; // create command line argument array
						// to initialize params, none in
						// this case
	try {
		Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
...
@Test
public void testreadFromURLandWriteScaledImageToFile() throws Exception {
	String progname = "Prog";
	...
	// directly execute bytecode
	String[] args = { "http://icons.iconarchive.com/icons/yellowicon/game-stars/256/Mario-icon.png", "abcd.png" }; // create
																													// command
																													// line
																													// argument
																													// array
...
@Test
public void testImgMove() throws Exception {
	String progname = "Prog";
...
@Test
public void testAssignImageAndFrame() throws Exception {
	String progname = "Prog";
